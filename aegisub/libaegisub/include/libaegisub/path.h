...
public:
	...
	/// of it to DirName again will result in truncating one level of directories.
	...
	static std::string StripExtension(std::string const& path);

	/// Get only the filename's extension, if any
