...
void CheckFileRead(agi::fs::path const& file) { Check(file, acs::FileRead); }
void CheckFileWrite(agi::fs::path const& file) { Check(file, acs::FileWrite); }
void CheckDirRead(agi::fs::path const& dir) { Check(dir, acs::DirRead); }
void CheckDirWrite(agi::fs::path const& dir) { Check(dir, acs::DirWrite); }
...
void Check(fs::path const& src, fs::path const& dst) { }
